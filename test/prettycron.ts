...
import { prettyCron } from '../src/prettycron';

function assertReadableOutput(item: any) {
    it(item.cron + ' == ' + item.readable, function () {
        var readable_output = prettyCron.toString(item.cron, !!item.sixth);
        assert.equal(readable_output, item.readable);
    });
}
describe('homepage examples', function () {
    describe('human-readable output', function () {
        [
            ...
            {
                cron: '0 * 1,3 * *',
                readable: 'Every hour, on the hour on the 1 and 3rd of every month',
            },
            ...
            {
                cron: '* 8,10,12,14,16,18,20 * * *',
                readable: 'Every minute of 8, 10, 12, 14, 16, 18 and 20th hour',
            },
            { cron: '0 12 15,16 1 3', readable: '12:00 on the 15 and 16th and every Wed in Jan' },
            {
                cron: '0 4,8,12,4 * * 4,5,6',
                readable: 'On the 4, 8 and 12th hour on Thu, Fri and Sat',
            },
            {
                cron: '0 2,16 1,8,15,22 * 1,2',
                readable:
                    '02:00 and 16:00 on the 1, 8, 15 and 22nd of every month and every Mon and Tue',
            },
            {
                cron: '15 3,8,10,12,14,16,18 16 * *',
                readable:
                    'Every 15th minute past the 3, 8, 10, 12, 14, 16 and 18th hour on the 16th of every month',
            },
            {
                cron: '2 8,10,12,14,16,18 * 8 0,3',
                readable:
                    'Every 2nd minute past the 8, 10, 12, 14, 16 and 18th hour on Sun and Wed in Aug',
            },
...
describe('extended format with seconds', function () {
    describe('human-readable output', function () {
        [
            ...
            {
                cron: '*/4 2 4 * * *',
                readable: 'Every 4 seconds on the 2nd minute past the 4th hour',
                sixth: true,
            },
            ...
            {
                cron: '*/30 * * * * *',
                readable: 'Every minute starting on the first and 30th second',
                sixth: true,
            },
            {
                cron: '5 * * * * *',
                readable: 'Every minute starting on the 5th second',
                sixth: true,
            },
            {
                cron: '5 */2 * * * *',
                readable: 'Every other minute starting on the 5th second',
                sixth: true,
            },
            {
                cron: '30 * * * * *',
                readable: 'Every minute starting on the 30th second',
                sixth: true,
            },
            {
                cron: '0,2,4,20 * * * * *',
                readable: 'Every minute starting on the 0, 2, 4 and 20th second',
                sixth: true,
            },
            {
                cron: '5,10/30 * * * 1,3 8',
                readable:
                    'Every minute starting on the 5, 10 and 40th second on Sat in Jan and Mar',
                sixth: true,
            },
            {
                cron: '15-17 * * * * *',
                readable: 'Every minute starting on the 15, 16 and 17th second',
                sixth: true,
            },
        ].forEach(assertReadableOutput);
    });
