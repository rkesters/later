  ...
  var tests = [
    {
      ...
      end: new LaterDate(2008, 0, 1, 0, 0, 59)
    },
    {
      // last second of year
      ...
      val: 59,
      extent: [0, 59],
      start: new LaterDate(2009, 11, 31, 23, 59),
    ...
    },
    {
      ...
      end: new LaterDate(2010, 7, 1, 0, 0, 59)
    },
    {
      ...
      val: 59,
      extent: [0, 59],
      start: new LaterDate(2011, 3, 30, 23, 59),
    ...
    },
    {
      ...
      end: new LaterDate(2012, 1, 28, 0, 0, 59)
    },
    {
      ...
      val: 59,
      extent: [0, 59],
      start: new LaterDate(2012, 1, 29, 23, 59),
    ...
    },
    {
      ...
      end: new LaterDate(2012, 10, 8, 14, 0, 59)
    },
    {
      ...
      val: 59,
      extent: [0, 59],
      start: new LaterDate(2013, 2, 10, 1, 59),
    ...
    },
    {
      ...
      end: new LaterDate(2013, 10, 3, 2, 0, 59)
    },
    {
      // last second of hour
      ...
      val: 59,
      extent: [0, 59],
      start: new LaterDate(2014, 1, 22, 6, 59),
    ...
    },
    {
      ...
      end: new LaterDate(2015, 5, 19, 18, 22, 59)
    },
    {
      ...
      val: 56,
      extent: [0, 59],
      start: new LaterDate(2016, 7, 29, 2, 56),
    ...
    },
    {
      ...
      val: 31,
      extent: [0, 59],
      start: new LaterDate(2017, 8, 4, 10, 31),
      end: new LaterDate(2017, 8, 4, 10, 31, 59)
    }
  ];

  runner(later, later.minute).run(tests);
