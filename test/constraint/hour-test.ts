  ...
  var tests = [
    {
      ...
      end: new LaterDate(2008, 0, 1, 0, 59, 59)
    },
    {
      // last second of year
      ...
      val: 23,
      extent: [0, 23],
      start: new LaterDate(2009, 11, 31, 23),
    ...
    },
    {
      ...
      end: new LaterDate(2010, 7, 1, 0, 59, 59)
    },
    {
      ...
      val: 23,
      extent: [0, 23],
      start: new LaterDate(2011, 3, 30, 23),
    ...
    },
    {
      ...
      end: new LaterDate(2012, 1, 28, 0, 59, 59)
    },
    {
      ...
      val: 23,
      extent: [0, 23],
      start: new LaterDate(2012, 1, 29, 23),
    ...
    },
    {
      ...
      end: new LaterDate(2012, 10, 8, 14, 59, 59)
    },
    {
      ...
      val: 1,
      extent: [0, 23],
      start: new LaterDate(2013, 2, 10, 1),
    ...
    },
    {
      ...
      end: new LaterDate(2013, 10, 3, 2, 59, 59)
    },
    {
      // last second of hour
      ...
      val: 6,
      extent: [0, 23],
      start: new LaterDate(2014, 1, 22, 6),
    ...
    },
    {
      ...
      val: 18,
      extent: [0, 23],
      start: new LaterDate(2015, 5, 19, 18),
      end: new LaterDate(2015, 5, 19, 18, 59, 59)
    },
    {
      ...
      val: 2,
      extent: [0, 23],
      start: new LaterDate(2016, 7, 29, 2),
      end: new LaterDate(2016, 7, 29, 2, 59, 59)
    },
    {
      // second
      ...
      val: 10,
      extent: [0, 23],
      start: new LaterDate(2017, 8, 4, 10),
      end: new LaterDate(2017, 8, 4, 10, 59, 59)
    }
  ];

  runner(later, later.hour).run(tests);
